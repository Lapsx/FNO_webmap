...
fno_core_path = os.path.abspath(os.path.join(current_dir, "../../scripts/fno_core"))
...
try:
    ...
    weights_path = os.path.abspath(os.path.join(current_dir, "../../models/fno_parametric_best_model.pth"))
...
async def get_loss_history():
    loss_path = os.path.abspath(os.path.join(current_dir, "../../models/parametric_loss_history.pt"))
